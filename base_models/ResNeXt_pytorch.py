...
class ResNeXt(nn.Module):
    ...
    """
    def __init__(self, baseWidth, cardinality, layers,in_ch, num_classes):
        """ Constructor
        Args:
...
def resnext50(baseWidth, cardinality,inch,cls):
    """
    Construct ResNeXt-50.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 6, 3],in_ch=inch,num_classes=cls)
    return model


def resnext101(baseWidth, cardinality,inch,cls):
    """
    Construct ResNeXt-101.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 23, 3], in_ch=inch,num_classes=cls)
    return model


def resnext152(baseWidth, cardinality,inch,cls):
    """
    Construct ResNeXt-152.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 8, 36, 3], in_ch=inch,num_classes=cls)
    return model
...
if __name__ == '__main__':
    ...
    model = resnext101(baseWidth=4, cardinality=32,inch=1,cls=38)
    out = model(img)
