...
class ShuffleNet(nn.Module):
    ...
    def __init__(self, num_blocks,in_ch, num_classes, groups):
        super().__init__()
        ...
        self.conv1 = BasicConv2d(in_ch, out_channels[0], 3, padding=1, stride=2)
...
def shufflenet_G1(in_ch,cls):
    return ShuffleNet([4, 8, 4], in_ch=in_ch,num_classes=cls, groups = 1)
def shufflenet_G2(in_ch,cls):
    return ShuffleNet([4, 8, 4], in_ch=in_ch,num_classes=cls, groups = 2)
def shufflenet_G3(in_ch,cls):
    return ShuffleNet([4, 8, 4], in_ch=in_ch,num_classes=cls, groups = 3)
def shufflenet_G4(in_ch,cls):
    return ShuffleNet([4, 8, 4], in_ch=in_ch,num_classes=cls, groups = 4)
def shufflenet_G8(in_ch,cls):
    return ShuffleNet([4, 8, 4], in_ch=in_ch,num_classes=cls, groups = 8)
